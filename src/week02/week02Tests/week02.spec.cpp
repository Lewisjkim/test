...
TEST_CASE("Test18")
{
    ...
    REQUIRE(spelling("eagerly") == std::vector<std::string>({"e", "ea", "eag", "eage", "eager", "eagerl", "eagerly"}));
    REQUIRE(spelling("believe") == std::vector<std::string>({"b", "be", "bel", "beli", "belie", "believ", "believe"}));
}
